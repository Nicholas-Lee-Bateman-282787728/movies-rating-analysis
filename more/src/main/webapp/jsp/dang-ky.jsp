...
<html lang="en">
    ...
    <body class="text-center">
        <form class="form-signin">
            ...
            <input type="password" id="re-password" class="form-control" placeholder="Nhập lại mật khẩu" required>
            <label for="lastName" class="sr-only">Họ</label>
            <input type="text" id="lastName" class="form-control" placeholder="Họ" required autofocus>
            <label for="middleName" class="sr-only">Tên đệm</label>
            <input type="text" id="middleName" class="form-control" placeholder="Tên đệm" required autofocus>
            <label for="firstName" class="sr-only">Tên</label>
            <input type="text" id="firstName" class="form-control" placeholder="Tên" required autofocus>
