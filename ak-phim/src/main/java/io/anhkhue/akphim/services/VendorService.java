...
import io.anhkhue.akphim.models.mining.report.Movies;
import io.anhkhue.akphim.models.mining.report.Report;
import io.anhkhue.akphim.models.mining.report.Vendor;
import io.anhkhue.akphim.repositories.VendorRepository;
    ...
    public Report getPredictionReport(int vendorId) {
        ...
        if (report == null) {
            ...
            List<io.anhkhue.akphim.models.mining.report.Movie> reportMovies =
                    movieList.stream()
                             .map(movie -> io.anhkhue.akphim.models.mining.report.Movie
                                     .builder()
